#############################################################################
# Makefile for building: lab2-project
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = lab2-project1.0.0
DISTDIR = /home/cappe/School/Lab2/lab2-project/.tmp/lab2-project1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		lab2-project.pro include.hpp audioSystem.cpp \
		bluetoothModule.cpp \
		dataStorage.cpp \
		display.cpp \
		errorHandling.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include.hpp $(DISTDIR)/
	$(COPY_FILE) --parents audioSystem.cpp bluetoothModule.cpp dataStorage.cpp display.cpp errorHandling.cpp externalInterfaces.cpp internetConnectivity.cpp main.cpp mediaLibrary.cpp navigationSystem.cpp settingsManager.cpp userInput.cpp $(DISTDIR)/
